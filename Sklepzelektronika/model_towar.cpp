...
model_towar::model_towar(QObject* parent)
    : QAbstractTableModel(parent)
{
}

int model_towar::rowCount(const QModelIndex& /*parent*/) const
{
    return dane_otrzymane.size();
}

int model_towar::columnCount(const QModelIndex& /*parent*/) const
{
    return 16;
}

QVariant model_towar::data(const QModelIndex& index, int role) const
{
    int row = index.row();
...
QVariant model_towar::headerData(int section, Qt::Orientation orientation, int role) const
{
